...
- Fix-in-PR items in a revision brief are in scope. Fix each as described, no wider. If one turns out much costlier than the brief implies, skip it and report it — it gets demoted to Follow-up.
</content>
